...
const LeadProfileFixedDetails = () => {
  ...
  return (
    <>
      <p className="mb-2">
        <span className="block font-semibold text-gray-500 mb-1">Status</span>
        <Badge className="flex text-white bg-indigo-400  border hover:bg-indigo-500/75 rounded-sm w-full py-2 px-4 text-center items-center justify-center text-sm">
      ...
      <p className="mb-2">
        ...
        <Badge
          variant="outline"
          className="rounded-sm py-2 w-full justify-center items-center text-center text-gray-700 gap-1 text-sm"
        >
          <Box size={20} />
          {leadProfile.source}
        </Badge>
      ...
      <p className="mb-2 flex items-center gap-2 justify-between ">
        ...
        <Badge
          variant={"outline"}
          className="inline-flex gap-1 items-center text-gray-700 font-medium text-sm"
        >
