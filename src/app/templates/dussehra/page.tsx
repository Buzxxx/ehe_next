          ...
          <tr>
            ...
            >
              <p style={{marginBottom:'1.25rem'}}>
                As we celebrate the triumph of good over evil this Dussehra, EHE
                Industries extends warm wishes of joy, peace, and prosperity to
                you and your loved ones. ✨
              </p>
              <p style={{marginBottom:'1.25rem'}}>
                This festive season is a perfect time to embrace new beginnings,
                and what better way to start afresh than with a beautiful new
                home? At EHE Industries, we offer a range of premium real estate
                options that cater to your dreams and aspirations.
              </p>
              <p style={{marginBottom:'1.25rem'}}>
                Whether you&apos;re looking for a serene home surrounded by nature, a
                vibrant urban lifestyle, or an investment that secures your
                future, we have the perfect property for you!
              </p>
              <h5 style={{ margin: "20px 0 10px", fontSize: "18px", fontWeight: '600' }}>
        ...
        >
          ...
          <tr>
            ...
            >
              ...
              <br />
              This is an auto-generated email. You received this email because
              you are subscribed.
            </td>
          </tr>
        </tfoot>
